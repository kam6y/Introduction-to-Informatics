...
<div>
  ...
  <ul>
    ...
    <li>分からないことはいつでも質問してください！（でも自分に聞くよりAIの方が詳しいです泣。練習にもなるのでAIがおすすめです。）</li>
...
<!-- .slide: class="layout-2col" -->
<div>
  <h2>ウォーターフォール開発とアジャイル開発の違い</h2>
  <ul>
    <li><strong>進め方</strong>: 全体設計→実装 vs 小さく作って学ぶ</li>
    <li><strong>変更への強さ</strong>: 変更コストが高い vs 変更前提で反復</li>
    <li><strong>成果の出し方</strong>: 最後に一括リリース vs 反復で小さくリリース</li>
    <li><strong>向く状況</strong>: 要件が安定 / 規制重視 vs 不確実性が高い / 速度重視</li>
  </ul>
</div>
<div>
  <img src="assets/Xor05BUf4UcNJFdosKEVWBeyQKfg3WwXsePBKbIu.jpg" alt="ウォーターフォールとアジャイルの対比イメージ" style="height: 46vh; object-fit: contain;" />
</div>
...
<!-- .slide: class="layout-table" -->
<h2>開発業務の役割マップ（2軸）</h2>
<p class="subtle">横軸: ビジネス寄り ↔ エンジニア寄り / 縦軸: 顧客に近い ↑ / 顧客から遠い ↓</p>
<table>
  <thead>
    <tr>
      <th></th>
  ...
  <tbody>
    <tr>
      <th>顧客に近い</th>
      <td>事業開発（BizDev） / PM</td>
      <td>UXリサーチャー / デザイナー</td>
    </tr>
    <tr>
      <th>顧客から遠い</th>
      <td>PO / PjM</td>
      <td>テックリード<br>ソフトウェアエンジニア<br>QA / テスト<br>SRE / インフラ</td>
    </tr>
  </tbody>
</table>
...
<!-- .slide: class="layout-3col" -->
<h2>顧客価値を見つける役割</h2>
<div>
  <h3>事業開発（BizDev）</h3>
  <p>業界の人に話を聞いたり、他社のやり方を調べたりして、いま本当に困っていることを見つけます。誰がどんな場面で困るのかを具体的にし、解決策が事業として成り立つかを確かめます。値付けや課金の方法、どうやってお金が回るかを考え、無理のない形にします。最後に、達成度を測るための数字の目標を置き、チームが同じ方向を向けるようにします。</p>
</div>
<div>
  <h3>プロダクトマネージャー（PM）</h3>
  <p>どの人のどの困りごとをどこまで解くのかを決め、作らないこともはっきりさせます。価値と時間、作る手間のバランスを見て、優先順位をつけます。短い期間で出す改善と、後で取り組む大きな改善を分けて全体の計画を描きます。関係する人たちに理由を説明し、納得してもらいながら判断を進めます。</p>
</div>
<div>
  <h3>UXリサーチャー / デザイナー</h3>
  <p>利用者に話を聞いたり実際の使い方を見たりして、行動や迷いを理解します。画面にどの情報をどんな順番で置くか、操作の流れが自然かを設計します。まずは簡単な試作品を作り、実際に触ってもらって確かめます。そこで見えた不便さや改善点を整理して、チームに伝えます。</p>
</div>
...
<div>
  <h3>プロダクトオーナー（PO）</h3>
  <p>やることリストを価値と手間、危なさの観点で整理し、今やるべきものをはっきりさせます。完了の基準を決めて「ここまでできたら合格」を共有します。短い期間ごとの目標を置き、毎回の成果が分かるようにします。作業を小さく分けて、迷わず進められる形に整えます。</p>
</div>
<div>
  <h3>プロジェクトマネージャー（PjM）</h3>
  <p>計画と実際の進み具合を比べながら、日程と費用を管理します。人の配置や役割の配分を調整し、足りない部分を早めに埋めます。問題になりそうな点を早めに拾い、関係する人と相談しながら対策を決めます。進み具合を見える形で共有し、定期的に報告します。</p>
</div>
<div>
  <h3>テックリード</h3>
  <p>全体の作り方の方針を決め、使う道具や作り方の基準を示します。画面とデータのつなぎ方や処理の流れを確認し、無理がないかを見ます。チームが困ったときに相談に乗り、一緒に手を動かして解決します。長く使う中で増える手直しの負担をどう減らすかも考えます。</p>
</div>
...
<div>
  <h3>ソフトウェアエンジニア</h3>
  <p>決めた内容を動く形にし、細かな動作確認を入れて品質を守ります。画面、処理、データの作りを具体化し、必要なつなぎ込みを作ります。あとから変更しやすいように部品に分け、読みやすく保ちます。見直しで気づきを共有し、より良い作りに直していきます。</p>
</div>
<div>
  <h3>QA / テストエンジニア</h3>
  <p>見るべきポイントの一覧を作り、どこをどの順で確かめるかを設計します。繰り返しの確認は機械に任せ、人が見るべき部分に時間を使います。不具合が起きたら再現手順をまとめ、原因がどこにあるかを追います。出してよいかどうかの判断基準を整え、品質の状態を見えるようにします。</p>
</div>
<div>
  <h3>SRE / インフラ</h3>
  <p>サービスが止まりにくくなるように、見張りの仕組みとトラブル対応の手順を整えます。緊急時に対応できる当番や手順書を用意し、落ち着いて直せる体制を作ります。更新作業や設定の管理をできるだけ自動にし、作業ミスを減らします。速さや費用のバランスを見ながら、日々の運用を改善します。</p>
</div>
...
<div>
  <h2>Issue駆動で進める</h2>
  <ul>
    <li>作業はIssueを起点に小さく分割</li>
    <li>受入条件・完了条件を先に書く</li>
    <li>Issueに紐づけてブランチ/PRを作る</li>
    <li>議論・決定・リンクをIssueに集約</li>
  </ul>
</div>
<div class="callout">
  <p><strong>基本フロー</strong></p>
  <p class="subtle">Issue作成 → ブランチ <code>feature/123</code> → PR → レビュー → クローズ</p>
  <p class="subtle">小さく閉じるほど進捗と品質が上がる</p>
</div>
